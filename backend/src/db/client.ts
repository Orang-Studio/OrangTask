...
export async function runMigrations() {
  ...
  const files = ['001_initial.sql', '002_refresh_tokens_pin.sql', '003_push_notifications.sql', '004_password_reset.sql', '005_oauth_accounts.sql', '006_api_keys.sql', '007_device_tokens.sql', '008_email_security.sql', '009_github_scratchpads.sql'].sort()
